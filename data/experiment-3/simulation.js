 ...
 *
 * IMPORTANT: Uses window.sim3_renderSimulation (not window.renderSimulation)
  ...
  return `
    ...
    <div class="card">
      ...
      <div style="display:flex;gap:12px;margin-bottom:24px;flex-wrap:wrap">
        <button onclick="sim3_showStep(0)" id="sim3_step0Btn" class="step-button active">Original Relation</button>
        <button onclick="sim3_showStep(1)" id="sim3_step1Btn" class="step-button">Step 1: 1NF</button>
        <button onclick="sim3_showStep(2)" id="sim3_step2Btn" class="step-button">Step 2: 2NF</button>
        <button onclick="sim3_showStep(3)" id="sim3_step3Btn" class="step-button">Step 3: 3NF</button>
      </div>
    </div>

    <!-- Step 0: Original -->
    <div id="sim3_step0" class="simulation-step">
      <div class="card">
    ...
    <!-- Step 1: 1NF -->
    <div id="sim3_step1" class="simulation-step" style="display:none">
      <div class="card">
    ...
    <!-- Step 2: 2NF -->
    <div id="sim3_step2" class="simulation-step" style="display:none">
      <div class="card">
    ...
    <!-- Step 3: 3NF -->
    <div id="sim3_step3" class="simulation-step" style="display:none">
      <div class="card">
...
window.sim3_showStep = function(n) {
  [0,1,2,3].forEach(i => {
    const el  = document.getElementById(`sim3_step${i}`);
    const btn = document.getElementById(`sim3_step${i}Btn`);
    if (el)  el.style.display  = i === n ? 'block' : 'none';
    if (btn) btn.classList.toggle('active', i === n);
  });
};

window.openGuide3 = function() {
  const modal = document.getElementById('guideModal3');
  if (modal) {
    modal.style.display = 'flex';
  }
};

window.closeGuide3 = function() {
  const modal = document.getElementById('guideModal3');
  if (modal) {
...
function startQuiz3Timer() {
  const randomDelay = Math.random() * 8000 + 15000; // 15-23 seconds
  console.log('Quiz3 Timer started, will show quiz in', Math.round(randomDelay/1000), 'seconds');
...
function showRandomQuiz3() {
  if (Math.random() > 0.4) { // 60% chance to show quiz
    const randomIndex = Math.floor(Math.random() * quiz3Questions.length);
    const question = quiz3Questions[randomIndex];
    displayQuiz3(question);
  }
}

function displayQuiz3(question) {
  console.log('Displaying Quiz3:', question.question);
...
window.initQuiz3 = function() {
  if (document.getElementById('sim3_step0')) {
